...
CREATE SCHEMA IF NOT EXISTS bozhyk_db DEFAULT CHARACTER SET utf8 ;
USE bozhyk_db ;

DROP TABLE IF EXISTS bozhyk_db.`owner`;
DROP TABLE IF EXISTS bozhyk_db.station;
DROP TABLE IF EXISTS bozhyk_db.owner_has_station;
DROP TABLE IF EXISTS bozhyk_db.panel;
DROP TABLE IF EXISTS bozhyk_db.panel_data;
DROP TABLE IF EXISTS bozhyk_db.price;
DROP TABLE IF EXISTS bozhyk_db.output;
DROP TABLE IF EXISTS bozhyk_db.household;
DROP TABLE IF EXISTS bozhyk_db.station_has_household;


CREATE TABLE bozhyk_db.`owner` (
...
CREATE TABLE bozhyk_db.station (
  id INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE bozhyk_db.household (
  id INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE bozhyk_db.owner_has_station (
...
CREATE TABLE bozhyk_db.station_has_household (
  station_id INT NOT NULL,
...
CREATE TABLE bozhyk_db.panel_data (
  id INT NOT NULL AUTO_INCREMENT,
  `date` DATETIME NULL,
  angle INT NULL,
  power INT NULL,
...
ALTER TABLE output
  ...
  ADD CONSTRAINT fk_output_station1
    ...
    REFERENCES bozhyk_db.station (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ADD CONSTRAINT fk_output_price1
    FOREIGN KEY (price_id)
    REFERENCES bozhyk_db.price (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
ALTER TABLE station_has_household
  ...
  ADD CONSTRAINT fk_station_has_household_household1
    ...
    REFERENCES bozhyk_db.household (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
